...
Students can record audio and upload DICOM folder, 3D files and documents (refer to different sections) Under **Summary** (on the left side) show different sections. 

![New Case11](img/newcase11.png)

Click **Upload file(s)** to upload images and documents.
...
<video src={require('./video/caseimages.mp4').default} controls></video>
